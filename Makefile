HTTP_SRC = srcs/http/request/RequestParser.cpp srcs/http/request/ResourceResolver.cpp srcs/http/request/UploadHandler.cpp\
...
CGI_SRC = srcs/cgi/CgiExecutor.cpp srcs/cgi/SessionHandler.cpp  srcs/cgi/SessionUtils.cpp
